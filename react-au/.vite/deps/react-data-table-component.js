...
var H = function(e3) {
  ...
  r3.setAttribute(A, "active"), r3.setAttribute("data-styled-version", "5.3.9");
  var i3 = q();
  ...
  function e3() {
    ...
    this._emitSheetCSS = function() {
      ...
      if (!t4)
        return "";
      var n2 = q();
      return "<style " + [n2 && 'nonce="' + n2 + '"', A + '="true"', 'data-styled-version="5.3.9"'].filter(Boolean).join(" ") + ">" + t4 + "</style>";
      ...
      if (e4.sealed)
        return j(2);
      var n2 = ((t4 = {})[A] = "", t4["data-styled-version"] = "5.3.9", t4.dangerouslySetInnerHTML = { __html: e4.instance.toString() }, t4), o2 = q();
