import {
  ...
  require_warning,
  useCol
} from "./chunk-BB6OHBWR.js";
import {
  Button_default,
  Button_default2,
  useButtonProps
} from "./chunk-N765AKHA.js";
import {
  ...
  useWillUnmount,
  useWindow
} from "./chunk-WFJLQ7JG.js";
import {
  createWithBsPrefix
} from "./chunk-6MHZPSW4.js";
import {
  require_prop_types
...
var Table = React79.forwardRef(({
  ...
  const classes = (0, import_classnames49.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime82.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
...
var ToastFade = React81.forwardRef((props, ref) => (0, import_jsx_runtime84.jsx)(Fade_default, {
  ...props,
  ref,
