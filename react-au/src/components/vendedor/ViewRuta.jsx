...
export default function ViewRuta() {
  const [data, setData] = useState([{
    ...
    "code": 414,
    "origen": "coatzacoalcos",
    "destino": "RANCHO SAN ANDRES ",
    "fecha_creacion": {
      "$date": "2023-04-20T16:15:51.757Z"
    },
    "updated_at": {
      "$date": "2023-05-04T20:17:40.270Z"
    },
    "precio": 29,
    "habilitado": 1,
    "__v": 0
